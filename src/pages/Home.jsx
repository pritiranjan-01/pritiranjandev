      ...
      >
        ...
        <section className="mb-12 sm:mb-14 md:mb-16 lg:mb-20 grid gap-6 sm:gap-8 md:grid-cols-[auto,minmax(0,1fr)] md:items-center">
          ...
          <div className="text-center md:text-left">
            ...
            <h1 className="gradient-text mb-3 pb-2 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight">
              Pritiranjan Mohanty
            </h1>
            <p className="text-base sm:text-lg text-light-textSecondary dark:text-dark-textSecondary">
              Java & Spring Boot Developer with a strong QA
              foundation, building scalable backend systems and clean,
        ...
        <section className="mb-12 sm:mb-14 md:mb-16 lg:mb-20">
          <div className="flex flex-col gap-6 md:flex-row md:items-start md:gap-10 lg:gap-16">
            ...
            <div className="flex flex-row sm:flex-row gap-3 md:flex-col md:min-w-fit">
              ...
              <a
                href={resumePDF}
                download="Pritiranjan_Java_Developer_Resume.pdf"
                className="flex-1 sm:flex-none rounded-full border border-light-border px-6 sm:px-7 py-2.5 text-sm font-semibold text-light-textPrimary transition-colors hover:bg-light-bgSecondary dark:border-dark-border dark:text-dark-textPrimary dark:hover:bg-dark-bgSecondary inline-block text-center"
              >
                Download CV
              </a>
            </div>
